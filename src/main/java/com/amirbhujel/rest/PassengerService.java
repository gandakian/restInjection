...
import com.amirbhujel.rest.dto.Passenger;
import com.amirbhujel.rest.dto.PassengerList;
...
public class PassengerService {
	...
	@GET
	// public PassengerList getPassengers(@QueryParam("start") int start,
	// @QueryParam("size") int size, String agent, HttpHeaders headers) {
	public PassengerList getPassengers(@QueryParam("start") int start, @QueryParam("size") int size,
		...
		MultivaluedHashMap<String, String> requestHeaders = (MultivaluedHashMap<String, String>) headers
				.getRequestHeaders();
